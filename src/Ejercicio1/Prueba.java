...
public class Prueba {
	...
	public static void main(String[] args) {
		...
		EmpresaServicios empre1 = new EmpresaServicios("Empresa1", "Servicio1", 112233);
		EmpresaServicios empre2 = new EmpresaServicios("Empresa2", "Servicio2", 445566);
		EmpresaServicios empre3 = new EmpresaServicios("Empresa3", "Servicio3", 778899);
		
		List<Object> pagos = new ArrayList<>();
		emple1.realizarPago(); emple2.realizarPago(); emple3.realizarPago(); emple4.realizarPago(); emple5.realizarPago(); emple6.realizarPago();
		empre1.realizarPago(); empre2.realizarPago(); empre3.realizarPago(); 
		pagos.add(emple1); pagos.add(emple2); pagos.add(emple3); pagos.add(emple4); pagos.add(emple5); pagos.add(emple6);
		pagos.add(empre1); pagos.add(empre2); pagos.add(empre3);
